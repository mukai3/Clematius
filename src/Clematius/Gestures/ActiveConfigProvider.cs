...
internal sealed class ActiveConfigProvider : IGestureContextProvider
{
    ...
    public void Update(ClematiusConfig config)
    {
        lock (_gate)
        {
            _config = config;
