using Clematius.Actions;
using Clematius.Config;
using Clematius.Gestures;
using Clematius.Hooks;
using Clematius.Scroll;
using Clematius.Tray;
using Clematius.Windowing;
...
internal sealed class AppContext : ApplicationContext
{
    ...
    private void OnConfigChanged(Clematius.Core.Config.ClematiusConfig cfg)
    {
    ...
    private static string FormatProgress(string strokes, Clematius.Core.Actions.GestureAction? action)
    {
